...
export class WorkInviteComponent {
  ...
  roles = new FormControl('', [
    Validators.required,
    Validators.pattern(/^(VIEWER|MEMBRO|FISCALIZAÇÃO|COORDENADOR|ARQUITETURA|ESTABILIDADE|ELETRICIDADE|GÁS|CANALIZAÇÃO|TELECOMUNICAÇÕES|TERMICO|ACUSTICO|TRANSPORTES|DIRETOR)$/)
  ]);
