...
insert into registo(oid, titulo, estado, creation_date, last_modification_date, author)
    values ('4c7eecdf-1caf-4763-ab38-eaeca807d509','O andaime não se encontrava corretamente instalado','No dia x observei que o andaime estava mal montado','FINISHED',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1),
           ('4c7eecdf-1caf-4763-ab38-eaeca807d509','Um dos tubos comprados encontra-se com defeito','Foi necessário comprar novos tubos aumentando a conta da obra por 50€','EDITÁVEL',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 );